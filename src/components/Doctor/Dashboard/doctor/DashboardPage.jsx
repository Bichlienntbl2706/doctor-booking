...
//                 const patientName = fullName || "Un Patient";
...
//                 return (
//                     <div>
//                         {moment(data?.scheduleDate).format("LL")} <span className="d-block text-info">{data?.scheduleTime}</span>
//                     </div>
//                 );
//             }
//         },
...
//                         {data?.status === 'pending' &&
//                             <>
//                                 <Button type="primary" icon={<FaCheck />} size="small" onClick={() => updatedAppointmentStatus(data, 'accept')}>Accept</Button>
//                                 <Button type='primary' icon={<FaTimes />} size='small' danger onClick={() => updatedAppointmentStatus(data, 'cancel')}>Cancel</Button>
//                             </>
//                         }
//                     </div>
//                 );
