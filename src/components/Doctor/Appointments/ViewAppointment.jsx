          ...
          <div>
            ...
            <div className="border border-light-subtle rounded p-3 d-flex gap-3">
              ...
              <div>
                ...
                <p className="mb-1 form-text">
                  Age :{" "}
                  {moment().diff(moment(data?.patientId?.dateOfBirth), "years")}
                  , Weight: {data?.patientId.weight}
                </p>
                <p className="mb-1 form-text">
                  Blood Group : {data?.patientId?.bloodGroup}
                </p>
                <p className="mb-1 form-text">
                  {data?.patientId?.address +
                    " , " +
                    data?.patientId?.city +
                    " , " +
                    data?.patientId?.country}
                </p>
