...
//     const { data, isError, isLoading } = useGetDoctorReviewsQuery(doctorData?._id);
//     let content = null;
...
//                                     <img className="" alt="" src={data?.patientId?.img ? data?.patientId?.img : img} />
//                                 </div>
//                                 <div>
//                                     <h5 className="text-nowrap text-capitalize">{item?.patientId?.firstName + ' ' + item?.patientId?.lastName}</h5>
...
//                                     />
//                                 </div>
//                                 <div className="">Reviewed {moment(item?.createdAt).startOf('hours').fromNow()}</div>
//                             </div>
//                         </div>
//                         <div>
        ...
        <div className="d-flex gap-4">
          <div className="review-img">
            <img
              className=""
              alt=""
              src={record.patientId?.img ? record.patientId?.img : img}
            />
          </div>
          <div>
