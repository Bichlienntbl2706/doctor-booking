    ...
    const handleValidation = (fieldName, value) => {
        ...
        switch (fieldName) {
            ...
            case 'cardExpiredYear':
                if (value.length !== 4 || ![2024, 2025, 2026, 2027, 2028].includes(parseInt(value))) {
                ...
                break;
            case 'cvv':
                newErrors.cvv = value.length !== 3 ? 'Must be 3 digits' : '';
                break;
            default:
                break;
        }
                        ...
                        <div className='row'>
                            ...
                            <di mb-3v className="col-md-6">
                                <div className="form-group card-label mb-3">
                                    ...
                                    <input className="form-control" id="card_name" value={nameOnCard && nameOnCard} type="text" onChange={(e) => handleChange(e)} onBlur={handleBlur} name='nameOnCard' />
                            ...
                            <div className="col-md-6">
                                <div className="form-group card-label mb-3">
                                    ...
                                    <input className="form-control" id="card_number" value={cardNumber && cardNumber} placeholder="1234  5678  9876  5432" type="number" onChange={(e) => handleChange(e)} onBlur={handleBlur} name='cardNumber' />
                            ...
                            <div className="col-md-4">
                                <div className="form-group card-label mb-3">
                                    ...
                                    <input className="form-control" id="expiry_month" value={expiredMonth && expiredMonth} placeholder="MM" type="number" onChange={(e) => handleChange(e)} onBlur={handleBlur} name='expiredMonth' />
                            ...
                            <div className="col-md-4">
                                <div className="form-group card-label mb-3">
                                    ...
                                    <input className="form-control" id="expiry_year" value={cardExpiredYear && cardExpiredYear} placeholder="YY" type="number" onChange={(e) => handleChange(e)} onBlur={handleBlur} name='cardExpiredYear' />
                            ...
                            <div className="col-md-4">
                                <div className="form-group card-label mb-3">
                                    ...
                                    <input className="form-control" id="cvv" type="number" value={cvv && cvv} onChange={(e) => handleChange(e)} onBlur={handleBlur} name='cvv' />
