        ...
        <div style={{ marginTop: '5rem'}}>
            ...
            <dir className="row">
                ...
                <div className="col-md-7 col-sm-12 mt-3">
                    {selectedDate && <h5 className='text-title mb-3'>Selected Date: <span className="text-danger"> {selectedDate && moment(selectedDate).format('LL')} </span> 
                    <br />
                     {selectTime &&  <span>Time:  <span className="text-danger">{selectTime}</span></span>} </h5> }
