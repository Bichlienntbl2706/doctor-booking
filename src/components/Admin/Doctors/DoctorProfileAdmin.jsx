...
const DoctorProfileAdmin = () => {
  ...
  useEffect(() => {
    if (doctorData) {
      ...
      setValue("postalCode", doctorData.postalCode);
      setValue("price", doctorData.price);
      setValue("specialization", doctorData.specialization);
      setValue("degree", doctorData.degree);
      setValue("college", doctorData.college);
      setValue("completionYear", doctorData.completionYear);
      setValue("experienceHospitalName", doctorData.experienceHospitalName);
      setValue("experienceStart", doctorData.experienceStart);
      setValue("experienceEnd", doctorData.experienceEnd);
      setValue("designation", doctorData.designation);
      setValue("award", doctorData.award);
      setValue("awardYear", doctorData.awardYear);
      setValue("registration", doctorData.registration);
      setValue("year", doctorData.year);
