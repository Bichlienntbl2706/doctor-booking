              ...
              <tbody>
                {filteredDoctors.map((doctor) => (
                  <tr key={doctor._id} className={doctor.isBlocked ? "table-secondary" : ""}>
                    ...
                    <td style={{ verticalAlign: "middle" }}>{doctor.gender}</td>
                    
                    <td style={{ verticalAlign: "middle" }}>{doctor.email}</td>
                    <td style={{ verticalAlign: "middle" }}>{doctor.phone}</td>
                    <td style={{ verticalAlign: "middle" }}>{new Date(doctor.createdAt).toLocaleDateString()}</td>
