            ...
            <tbody>
              {filteredReviews.map((review, index) => (
                <tr key={review._id}>
                  ...
                  <td style={{width: '13%'}} className="table-avatar">
                    <img
                      src={review.patientId.img ? review.patientId.img : pImage}
                      alt="avatar"
                      className="avatar-img rounded-circle me-2"
                    />
                    {review.patientId ? (
                      <Link to={`/admin/patients/${review.patientId._id}`}>
                  ...
                  <td  style={{width: '10%'}} className="text-warning">
                    {"★".repeat(Number(review.star))}
                    {"☆".repeat(5 - Number(review.star))}
                  </td>
                  <td style={{width: '13%'}}>
                  <img
                      src={review.doctorId.img ? review.doctorId.img : dImage}
                      alt="avatar"
                      className="avatar-img rounded-circle me-2"
                    />
                    {review.patientId ? (
                      <Link to={`/admin/doctors/${review.doctorId?._id}`}>
                  ...
                  <td style={{width: '10%'}}>{new Date(review.createdAt).toLocaleDateString()}</td>
                  <td style={{width: '50%'}}>
                    <div className="comment rounded p-2">
                      {review.description}
                    </div>
                  </td>
                </tr>
