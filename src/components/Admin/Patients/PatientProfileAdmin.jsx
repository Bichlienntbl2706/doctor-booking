            ...
            <form className="row form-row" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="col-md-6">
                    <div className="form-group mb-2 card-label">
                        ...
                        <input defaultValue={patientData?.firstName} {...register("firstName")} className="form-control" />
                    </div>
                </div>
                <div className="col-md-6">
                    <div className="form-group mb-2 card-label">
                        <label>Last Name <span className="text-danger">*</span></label>
                        <input defaultValue={patientData?.lastName} {...register("lastName")} className="form-control" />
                    </div>
                </div>
                <div className="col-md-6">
                    <div className="form-group mb-2 card-label">
                        <label>Email <span className="text-danger">*</span></label>
                        <input defaultValue={patientData?.email} disabled className="form-control" />
                    </div>
                </div>
                ...
                <div className="col-md-6">
                    <div className="form-group mb-2 card-label">
                        ...
                        <input defaultValue={patientData?.mobile} {...register("mobile")} className="form-control" />
                    </div>
                </div>
                <div className="col-md-6">
                ...
                <div className="col-md-6 row pr-4">
                    ...
                    <div className="form-group mb-2 col-md-6">
                        ...
                        <input defaultValue={patientData?.weight} {...register("weight")} className="form-control" />
                    </div>
                </div>
                ...
                <div className="col-md-6">
                    <div className="form-group mb-2">
                        ...
                        <input defaultValue={patientData?.city} {...register("city")} className="form-control" />
                    </div>
                </div>
                ...
                <div className="col-md-6">
                    <div className="form-group mb-2 card-label">
                        <label>State</label>
                        <input defaultValue={patientData?.state} {...register("state")} className="form-control" />
                    </div>
                </div>
                <div className="col-md-6">
                    <div className="form-group mb-2 card-label">
                        <label>Zip Code</label>
                        <input defaultValue={patientData?.zipCode} {...register("zipCode")} className="form-control" />
                    </div>
                </div>
                <div className="col-md-6">
                    <div className="form-group mb-2 card-label">
                        <label>Country</label>
                        <input defaultValue={patientData?.country} {...register("country")} className="form-control" />
                    </div>
                </div>
                <div className="col-md-6">
                    <div className="form-group mb-2 card-label">
                        <label>Address</label>
                        <input defaultValue={patientData?.address} {...register("address")} className="form-control" />
                    </div>
                </div>
