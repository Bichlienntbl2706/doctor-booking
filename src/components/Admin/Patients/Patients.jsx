              ...
              <tbody>
                {filteredPatients.map((patient) => (
                  ...
                  >
                    ...
                    <td style={{ verticalAlign: "middle" }}>{new Date(patient.createdAt).toLocaleDateString()}</td>
                    <td style={{ verticalAlign: "middle" }}>{patient.email}</td>
                    <td style={{ verticalAlign: "middle" }}>{patient.gender}</td>
